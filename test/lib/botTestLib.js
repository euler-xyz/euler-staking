...
const deploy = async (ctx) => {
  ctx.factories.RewardsDistribution = await ethers.getContractFactory('RewardsDistribution');
  ctx.factories.StakingRewards = await ethers.getContractFactory('StakingRewards');
